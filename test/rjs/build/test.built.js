    ...
    */
    ...
    if (typeof(exports) !== UNDEF_TYPE) {
        ...
        */
        ...
        if (typeof SomeNameSpace.define === 'function' && SomeNameSpace.define.amd) {
            SomeNameSpace.define('../../src/ua-parser.js',[],function () {
                return UAParser;
            });
        } else if (window) {
            // browser env
 ...
 */
SomeNameSpace.require(['../../src/ua-parser.js'], function (uaParser) {
    'use strict';
...
SomeNameSpace.define("rjs.main", function(){});
