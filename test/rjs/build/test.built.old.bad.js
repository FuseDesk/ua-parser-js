    ...
    if (typeof(exports) !== UNDEF_TYPE) {
        ...
        */
        ...
        if (typeof(define) === FUNC_TYPE && define.amd) {
            SomeNameSpace.define('../../src/ua-parser.old.js',[],function () {
                return UAParser;
            });
        } else if (window) {
            // browser env
 ...
 */
SomeNameSpace.require(['../../src/ua-parser.old.js'], function (uaParser) {
    'use strict';
...
SomeNameSpace.define("rjs.main.old.bad", function(){});
